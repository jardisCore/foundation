...
class DomainKernelTest extends TestCase
{
    ...
    public function testKernelCanProvideCache(): void
    {
        try {
            ...
            $this->markTestSkipped('Cache service unavailable: ' . $e->getMessage());
        }
    ...
    public function testKernelCanProvideMessaging(): void
    {
        try {
            ...
            $this->markTestSkipped('Messaging service unavailable: ' . $e->getMessage());
        }
    ...
    public function testAllServicesCanBeInitializedTogether(): void
    {
        ...
        try {
            ...
            $this->markTestSkipped('Service unavailable: ' . $e->getMessage());
        }
    ...
    public function testKernelProvidesResourceRegistry(): void
    {
        ...
        $this->assertInstanceOf(\JardisPort\Foundation\ResourceRegistryInterface::class, $resources);
    }
}
