...
- **ConnectionProvider** — Central DI-based connection management for PDO, Redis, Kafka, RabbitMQ with typed access, lazy factories, and cross-domain sharing
...
- **Smart Logging** — Conditional routing, sampling, fingers-crossed buffering, 20 handler types (File, Slack, Teams, Loki, Kafka, RabbitMQ, Email, Webhook, etc.)
...
- **Cross-Domain Connection Sharing** — Multiple kernels automatically share connections via `ConnectionProvider`
...
class EcommerceDomain extends Domain
{
    protected function createKernel(
        ...
        return new EcommerceKernel($appRoot, $domainRoot, $classVersion, $connections, $sharedRuntimeRoot);
    }
}
```
